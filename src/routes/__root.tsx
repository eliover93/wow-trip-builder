  ...
  head: () => ({
    meta: [
      ...
      { title: "Voyara · Propuestas de viaje con efecto wow para agencias" },
      {
        name: "description",
        content:
          "Software para agencias de viaje: crea paquetes dinámicos con itinerario, presupuesto y animaciones.",
      },
      { name: "author", content: "Voyara" },
      { property: "og:title", content: "Voyara · Propuestas de viaje con efecto wow" },
      {
        property: "og:description",
        content: "Backoffice sencillo para la agencia, propuesta espectacular para el cliente.",
      },
